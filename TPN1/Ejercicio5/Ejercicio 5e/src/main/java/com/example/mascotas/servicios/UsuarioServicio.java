...
public class UsuarioServicio {
    ...
    // cada vez que se ejecuta alguna de estas funciones se realiza una transaccion en la bd
    @Transactional
    public UsuarioDTO modificar(MultipartFile archivo, String id, String nombre, String apellido, String mail, String clave, String clave2, String idZona) throws ErrorServicio {
        ...
        if (respuesta.isPresent()) {
            ...
            usuarioRepositorio.save(usuario);
            return dtoConversor.convertir(usuario);
        } else {
